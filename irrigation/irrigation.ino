...
const int Sprinkler_Pump_Pin;
bool Sprinkler_Pump_Status = false;

const int Drip_Pump_Pin;
bool Drip_Pump_Status = false;


const int Drain_Tank_Water_Level_Sensor_Pin;
bool Drain_Tank_Water_Level = LOW;

const int Drain_Pump_Pin;
bool Drain_Pump_Status = false;

const int Tank1_Mixer_Relay_Pin;
const int Tank1_PH_Sensor_Pin;
const int Tank1_PPM_Sensor_Pin;
...
const int Tank2_Mixer_Relay_Pin;
const int Tank2_PH_Sensor_Pin;
const int Tank2_PPM_Sensor_Pin;
...
void setup() {
  ...
  pinMode(Tank1_Water_Level_Sensor_Pin, INPUT);
  
  pinMode(Tank2_PH_Sensor_Pin, INPUT);
  pinMode(Tank2_PPM_Sensor_Pin, INPUT);
  pinMode(Tank2_Water_Level_Sensor_Pin, INPUT);
}
/*--------------------------------------------------------------------------------------
 * 
 *  Sensor data reading
